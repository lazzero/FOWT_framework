------- OpenFAST v3.0 INPUT FILE ------------------------------------------------
FAST File for Pala-seg
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
 "EOL_CK_60_ED.dat"						EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
 "../unused"      						BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
 "../unused"      						BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
 "../unused"      						BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
 "EOL_CK_60_PL6_ifw.dat"		   		InflowFile      - Name of file containing inflow wind input parameters (quoted string)
 "EOL_CK_60_ADv14_twrshd.ipt"			AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
 "EOL_CK_60_PL6_SvrD.dat"		 		ServoFile       - Name of file containing control and electrical-drive input parameters
 "HydraSpar_Livorno_HD.dat"				HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
 "../unused"      						SubFile         - Name of file containing sub-structural input parameters (quoted string)
 "Hydraspar_mooring.dat"				MooringFile     - Name of file containing mooring system input parameters (quoted string)
