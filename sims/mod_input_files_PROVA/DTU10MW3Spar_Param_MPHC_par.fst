------- FAST v3.0.0 INPUT FILE ------------------------------------------------
FAST          model         - of the DTU 10MW Reference Wind Turbine on INNWIND.EU TripleSpar platform
---------------------- SIMULATION CONTROL --------------------------------------
True          Echo          - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel    - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
300           TMax          - Total run time (s)
0.025         T             - Recommended module time step (s)
...
---------------------- INPUT FILES ---------------------------------------------
DTU10MW3Spar_EDFile_MPHC_par.dat EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
DTU10MW3Spar_HydroFile_MPHC_par.dat HydroFile     - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile       - Name of file containing sub-structural input parameters (quoted string)
DTU_10MW_RWT_TripleSpar_MoorDyn_MPHC_par.dat MooringFile   - Name of file containing mooring system input parameters (quoted string)
...
0             Bld_Kdmp      - Damping factor for the blades [used only if CalcSteady=True] (N/(m
